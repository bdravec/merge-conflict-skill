...
| Bucket | 8B (%) | 8B+skill (%) | 70B (%) | Gap (pp) | Recovered (pp) | Closure |
|---|---:|---:|---:|---:|---:|---:|
...
\begin{table}[htbp]
  ...
  \caption{Apertus scaling-axis gap closure with skill-v2.1 in the system prompt,
    ...
    A closure above $100\%$ means the 8B+skill solved rate overtook the 70B baseline.
    The Apertus large anchor is 70B ($\sim$9$\times$), so \emph{Gap} is not directly
    comparable to the Qwen3 (32B) table.}
  \label{tab:apertus_gap_closure}
  \begin{tabular}{lrrrrrr}
    \toprule
                   & \multicolumn{3}{c}{Solved rate (\%)} &          &            &          \\
    \cmidrule(lr){2-4}
    Bucket         & 8B    & 8B+skill & 70B   & Gap (pp) & Recov.\ (pp)      & Closure          \\
    \midrule
    func           & \phantom{0}7.1 & 11.7           & 15.6  & \phantom{0}8.5 & $+4.7$          & $+55\%$          \\
    sytx           & \phantom{0}4.7 & 11.7           & 17.5  & 12.8           & $+7.0$          & $+54\%$          \\
    sytx+func      & 11.7           & 14.8           & 14.1  & \phantom{0}2.3 & $+3.1$          & $+133\%$         \\
    text           & 22.9           & 27.4           & 34.0  & 11.1           & $+4.5$          & $+40\%$          \\
    text+func      & 19.4           & 25.6           & 27.2  & \phantom{0}7.9 & $+6.2$          & $+79\%$          \\
    text+sytx      & 17.3           & 25.9           & 34.6  & 17.3           & $+8.6$          & $+50\%$          \\
    text+sytx+func & 40.8           & 53.0           & 51.5  & 10.7           & $+12.2$         & $+114\%$         \\
    \midrule
    Aggregate      & 21.47          & 28.57          & 31.52 & 10.05          & $+7.10$         & $+71\%$          \\
