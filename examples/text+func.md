# `text+func` bucket — worked examples
...
<th align="left">v1-sys (max=0.982)</th>
<th align="left">v2-sys (max=0.973)</th>
<th align="left">v2.1-sys (max=0.970)</th>
...
**combine** &nbsp;·&nbsp; 1.7× over-gen &nbsp;·&nbsp; max=**0.970**
...
<tr>
<th align="left">Conflict</th>
<th align="left">v1-sys (max=0.944)</th>
<th align="left">v2-sys (max=0.947)</th>
<th align="left">v2.1-sys (max=0.894)</th>
<th align="left">Ground truth</th>
</tr>
<tr>
<td valign="top">
...
<tr>
<th align="left">Conflict</th>
<th align="left">v1-sys (max=0.181)</th>
<th align="left">v2-sys (max=0.861)</th>
<th align="left">v2.1-sys (max=0.812)</th>
<th align="left">Ground truth</th>
</tr>
<tr>
<td valign="top">
...
<tr>
<th align="left">Conflict</th>
<th align="left">v1-sys (max=0.897)</th>
<th align="left">v2-sys (max=0.963)</th>
<th align="left">v2.1-sys (max=0.310)</th>
<th align="left">Ground truth</th>
</tr>
<tr>
<td valign="top">
...
def is_unaligned_buffer(arg: TensorArg):
    ...
    if buf_name in V.graph.graph_inputs:
        return buf_name not in V.graph.aligned_inputs
    elif buf_name in V.graph.constants:
        return False
    else:
        if V.graph.scheduler:
            layout = V.graph.scheduler.get_buffer_layout(buf_name)
...
def config_of(
    ...
    *,
    ...
    if len(indices) != len(args):
        raise ValueError("Indices length must match argument count")
    return [arg.config for i, arg in enumerate(args) if i in indices]
```
...
def config_of(
    ...
    *,
    ...
    if indices is None:
        return config_of(args, indices=range(len(args)))
    else:
        return config_of(args, indices=indices)
```
...
**custom** &nbsp;·&nbsp; 1079.0× over-gen &nbsp;·&nbsp; max=**0.000**

</td>
<td valign="top">

**pick-b** &nbsp;·&nbsp; 815.0× over-gen &nbsp;·&nbsp; max=**0.000**

</td>
<td valign="top">

**custom** &nbsp;·&nbsp; 1001.0× over-gen &nbsp;·&nbsp; max=**0.000**
...
**pick-b** &nbsp;·&nbsp; 889.0× over-gen &nbsp;·&nbsp; max=**0.000**

</td>
<td valign="top">

**pick-b** &nbsp;·&nbsp; 831.0× over-gen &nbsp;·&nbsp; max=**0.000**

</td>
<td valign="top">

**pick-b** &nbsp;·&nbsp; 776.0× over-gen &nbsp;·&nbsp; max=**0.000**
